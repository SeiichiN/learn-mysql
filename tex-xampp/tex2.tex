...
\vspace{3mm}
\includegraphics[width=14cm]{../03-config/21-config.png}
\vspace{3mm}
...
\vspace{3mm}
\includegraphics[width=13cm]{../03-config/22-terapad.png}
\vspace{3mm}
...
『PHPノート』に載っている mbstring の設定は、PHP5.6以降(だったかな)は不要(非推奨)である。
