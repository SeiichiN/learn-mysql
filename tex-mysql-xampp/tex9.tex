...
\vspace{-3mm}
\begin{enumerate}
 \item gender表の主キー(gid)はchar型にする。
\end{enumerate}
...
person\_teizan表 \\
\begin{tabular}{|c|c|} \hline
 person\_id & teizan\_id \\ \hline\hline
 1 &   20 \\ \hline
 1 &   30  \\ \hline
 1 &   50  \\ \hline
 2 &   26  \\ \hline
...
\begin{enumerate}
 \item person\_teizan表は、personを表すキーとteizanを表すキーの2つが主キーと
       なっている(複合主キー)。
 \item person\_id は int型であり、主キーである。
 \item teizan\_id は int型であり、主キーである。
\end{enumerate}
