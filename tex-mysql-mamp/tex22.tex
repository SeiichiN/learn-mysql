...
MacやLinuxだと、cp932 のところが utf8 になっているはずである。
\footnote{mysqlクライアントが mysqldサーバーに接続
...
MAMPの場合、初期状態(この状態)で Windowsに最適な設定になっているはずである。
